...
const boundBoxCallbackForCircle = (oldBox, newBox) => {
  // limit resize
  if (
    newBox.width < LIMITS_SHAPE_VALUE.CIRCLE.MIN ||
    newBox.height < LIMITS_SHAPE_VALUE.CIRCLE.MIN ||
    newBox.width > LIMITS_SHAPE_VALUE.CIRCLE.MAX ||
    newBox.height > LIMITS_SHAPE_VALUE.CIRCLE.MAX
  ) {
    return oldBox;
  }
  return newBox;
